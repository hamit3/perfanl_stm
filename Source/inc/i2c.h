...
extern void I2C_Write_Bulk(uint32_t Device, uint32_t Register, uint32_t *Data, uint32_t Lenght);
extern void I2C_Write_NoAck(uint32_t Device, uint32_t Register, uint32_t *Data, uint32_t Lenght);
